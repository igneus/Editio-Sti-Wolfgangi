...
\pars{Léctio san\textit{cti} Evangélii {\textnormal{\grestar{}}} secúndum Jo\textit{án}nem.} \scriptura{Joannes 14, 23-31}

\textusEtTranslatio{
  Respóndit Jesus \textit{et} dixit ei:~\grestar{}
  ...
  sed ejus, qui misit me, \textbf{Pat}ris.
  ...
  quia vado ad Patrem: quia Pater major \textbf{me} est.
  Et nunc dixi vobis, \textit{pri}úsquam fiat:~\grestar{}
  ut, cum factum fúerit, cre\textbf{dá}tis.
  Jam non mul\textit{ta} loquar vobíscum:~\grestar{}
  venit enim princeps mundi hujus, et in me non habet \textbf{quid}quam.
...
\vfill
\newgeometry{landscape, a4paper, mag=1166, truedimen, left=2cm, right=1.5cm, top=1.6cm, bottom=0.60cm}
\pagebreak
...
%\vfill
\newgeometry{landscape, a4paper, mag=1166, truedimen, left=2cm, right=1.5cm, top=1.6cm, bottom=0.95cm}
\pagebreak
