...
\includescore{temporalia/ps50-initium-vii-a-auto.gtex}

\psalmusEtTranslatioT{temporalia/ps50-comb.tex}{10cm}

\includescore{temporalia/ant1.gtex} % repeat the antiphon - new page
...
\includescore{temporalia/ps63-initium-ii-D-auto.gtex}
...
\includescore{temporalia/ps64-initium-viii-C-auto.gtex}
...
\includescore{temporalia/anna-initium-i-g2-auto.gtex}
...
\includescore{temporalia/ps148-initium-ii-D-auto.gtex}
...
\includescore{temporalia/ps149-initium-ii-D-auto.gtex}
...
\includescore{temporalia/ps150-initium-ii-D-auto.gtex}
...
\includescore{temporalia/capitulum-Nox.gtex}
...
\superInitialam{VI}
\includescore{temporalia/respbr.gtex}
...
\includescore{temporalia/hym-NoxEtTenebraeHieme.gtex}
...
\includescore{temporalia/hym-NoxEtTenebraeAEstate.gtex}
\input{hym-NoxEtTenebrae-bohtext.tex}
...
\includescore{temporalia/benedictus-initium-i-g5-auto.gtex}

\psalmusEtTranslatioT{temporalia/benedictus-comb.tex}{10cm}

\includescore{temporalia/ant-ben.gtex} % repeat the antiphon - new page
...
\includescore{temporalia/benedicamus-feria-laudes.gtex}
...
\includescore{temporalia/ant-salveregina-simplex.gtex}
